...
/**
 * 规则表达式，一个规则对应多个表达式 字段属性枚举类
 */
public enum ExpressionDefinition implements EnumDomainDef {
     ...
     * 获取对应字段的属性信息
	 */
	private final ColumnProperty propertyModel = DomainUtil.getPropertyModel(Expression.class, this.name());
