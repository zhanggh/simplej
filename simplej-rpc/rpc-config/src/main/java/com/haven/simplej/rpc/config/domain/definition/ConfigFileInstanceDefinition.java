 ...
 */
public enum ConfigFileInstanceDefinition implements EnumDomainDef {
     ...
     * 获取对应字段的属性信息
	 */
	private final ColumnProperty propertyModel = DomainUtil.getPropertyModel(ConfigFileInstance.class, this.name());
	...
	public static String getTableName() {
		return "rpc_config.config_file_instance";
	}
}