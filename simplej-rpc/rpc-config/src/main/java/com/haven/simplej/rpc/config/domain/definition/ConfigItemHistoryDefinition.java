 ...
 * 属性配置信息日志 字段属性枚举类
 */
public enum ConfigItemHistoryDefinition implements EnumDomainDef {
     ...
     * 获取对应字段的属性信息
	 */
	private final ColumnProperty propertyModel = DomainUtil.getPropertyModel(ConfigItemHistory.class, this.name());
	...
	public static String getTableName() {
		return "rpc_config.config_item_history";
	}
}