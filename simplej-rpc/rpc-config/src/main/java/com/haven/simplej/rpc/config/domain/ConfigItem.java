...
import com.haven.simplej.rpc.config.domain.definition.ConfigItemDefinition;
...
@Table(name = "config_item", schema = "rpc_config", indexes = { // catalog 定义为分表数
...
public class ConfigItem extends BaseDomain {
	...
	public ConfigItem (ConfigItem that){
        super(that);
	...
	public String getTableName(){
        ...
        return ConfigItemDefinition.getTableName();
    }

	@Override
	public EnumDomainDef[] getFields(){
		EnumDomainDef[] defs = ConfigItemDefinition.values();
        return defs;
    }
}