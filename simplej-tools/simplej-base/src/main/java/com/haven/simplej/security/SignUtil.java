...
import com.haven.simplej.security.enums.KeyFactoryAlgorithms;
...
public class SignUtil {
	...
	public static KeyFactoryAlgorithms convert2KeyAlgorithm(SignAlgorithm signAlgorithm){
		...
		String algoritm = StringUtils.substring(signAlgorithm.name(), signAlgorithm.name().indexOf("with") + 4,
				signAlgorithm.name().length());
		switch (algoritm){
			case "RSA":
