package com.haven.simplej.db.transaction;
 ...
 *
 * <p>
 * Application code is required to retrieve the JDBC Connection via {@link DataSourceUtils#getConnection(DataSource)} instead of a standard J2EE-style {@link DataSource#getConnection()} call. Spring classes such as {@link org.springframework.jdbc.core.JdbcTemplate} use this strategyBeanName implicitly. If not used in combination with this transaction manager, the {@link DataSourceUtils} lookup strategyBeanName behaves exactly like the native DataSource lookup; it can thus be used in a portable fashion.
 *
 * <p>
...
public class SmartDataSourceTransactionManager extends AbstractPlatformTransactionManager
